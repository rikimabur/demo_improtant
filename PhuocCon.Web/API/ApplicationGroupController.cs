...
namespace PhuocCon.Web.API
{
    ...
    public class ApplicationGroupController : ApiControllerBase
    {
        ...
        public ApplicationGroupController(IErrorService errorService,IApplicationRoleService appRoleService,ApplicationUserManager userManager,IApplicationGroupService appGroupService) : base(errorService)
        {
