...
namespace PhuocCon.Web.API
{
    ...
    public class ApplicationUserController : ApiControllerBase
    {
        ...
        public HttpResponseMessage Detail(HttpRequestMessage request, string id)
        {
            ...
            {
                return request.CreateResponse(HttpStatusCode.BadRequest, nameof(id) + " không có giá trị.");
            }
       ...
       // [Authorize(Roles = "AddUser")]
        public async Task<HttpResponseMessage> Create(HttpRequestMessage request, ApplicationUserViewModel applicationUserViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    {
                        return request.CreateResponse(HttpStatusCode.BadRequest, string.Join(",", result.Errors));
                    }
                }
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        _appGroupService.AddUserToGroup(listAppUserGroup, appUser.Id);
                        _appGroupService.Save();
                        return request.CreateResponse(HttpStatusCode.OK, applicationUserViewModel);
                    }
                    else
        ...
        public async Task<HttpResponseMessage> DeleteUser(HttpRequestMessage request, string id)
        {
