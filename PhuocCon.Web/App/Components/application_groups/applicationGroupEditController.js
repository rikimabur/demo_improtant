(function (app) {
    ...
    function applicationGroupEditController($scope, apiService, notificationService, $location, $stateParams) {
        ...
        function addSuccessed() {
            notificationService.displaySuccess($scope.group.Name + 'Đã cập nhật thành công.');
        ...
        function loadRoles() {
            apiService.get('/api/applicationRole/getlistall', null,
                function (response) {
...
})(angular.module('PhuocConShop.application_groups'));